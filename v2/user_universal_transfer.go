...
// CreateListUserUniversalTransfer fetches transfer history.
//
// See https://binance-docs.github.io/apidocs/spot/en/#query-user-universal-transfer-history-user_data
type CreateListUserUniversalTransfer struct {
	c          *Client
	type_      string
	startTime  *int64
	endTime    *int64
...
func (s *CreateListUserUniversalTransfer) Type(v string) *CreateListUserUniversalTransfer {
	s.type_ = v
	return s
}

// StartTime sets the startTime parameter.
func (s *CreateListUserUniversalTransfer) StartTime(v int64) *CreateListUserUniversalTransfer {
	s.startTime = &v
	return s
}

// EndTime sets the startTime parameter.
func (s *CreateListUserUniversalTransfer) EndTime(v int64) *CreateListUserUniversalTransfer {
	s.startTime = &v
	return s
}

// Current sets the current parameter.
func (s *CreateListUserUniversalTransfer) Current(v int) *CreateListUserUniversalTransfer {
	s.current = &v
	return s
}

// Size sets the size parameter.
func (s *CreateListUserUniversalTransfer) Size(v int) *CreateListUserUniversalTransfer {
	s.current = &v
	return s
}

// FromSymbol set fromSymbol
func (s *CreateListUserUniversalTransfer) FromSymbol(v string) *CreateListUserUniversalTransfer {
	s.fromSymbol = &v
	return s
}

// ToSymbol set toSymbol
func (s *CreateListUserUniversalTransfer) ToSymbol(v string) *CreateListUserUniversalTransfer {
	s.toSymbol = &v
	return s
}
